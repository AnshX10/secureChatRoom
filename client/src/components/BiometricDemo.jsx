...
const BiometricDemo = () => {
  ...
  return (
    <div className="min-h-[100dvh] bg-[#09090b] text-white font-sans p-4 sm:p-6 md:p-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8 sm:mb-12">
          <div className="flex items-center justify-between mb-6 sm:mb-8">
            <button
              ...
              className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl border border-zinc-800/50 bg-zinc-900/50 backdrop-blur-sm text-zinc-400 hover:text-white hover:border-zinc-600 transition-all text-xs sm:text-sm"
            >
          ...
          <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-white/5 border border-zinc-700/20 flex items-center justify-center mx-auto mb-4 sm:mb-5">
            <LuLock className="text-white" size={32} />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
          {/* Capabilities Panel */}
          <div className="rounded-2xl border border-zinc-800/40 bg-[#0f0f11]/80 backdrop-blur-xl p-4 sm:p-6">
            <h2 className="text-base sm:text-lg font-semibold text-white mb-4 sm:mb-5 flex items-center gap-2.5">
        ...
        {/* Feature Explanation */}
        <div className="mt-8 sm:mt-12 rounded-2xl border border-zinc-800/40 bg-[#0f0f11]/80 backdrop-blur-xl p-5 sm:p-8">
          <h2 className="text-lg sm:text-xl font-semibold text-white mb-5 sm:mb-8 text-center">
            How It Works
          </h2>
