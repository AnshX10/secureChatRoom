...
export default function PrivacyPolicy() {
  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-white">
      <LegalScrollProgressBar containerId="privacy-policy-content" />
      <div id="privacy-policy-content" className="max-w-4xl mx-auto px-5 sm:px-8 py-10 sm:py-14">
        ...
        <div className="mb-10 flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div>
            <h1 className="text-3xl sm:text-4xl font-black tracking-tight mb-2">{privacy?.title || "Privacy Policy"}</h1>
            <p className="text-zinc-500 text-sm">Last updated: {privacy?.lastUpdated || "April 2, 2026"}</p>
          </div>

          <PolicyLanguageSwitcher className="w-full md:w-[320px] md:shrink-0" widgetId="privacy-google-translate" />
        </div>
